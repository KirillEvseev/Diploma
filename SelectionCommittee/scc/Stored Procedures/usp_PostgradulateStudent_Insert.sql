...
CREATE PROCEDURE [scc].[usp_PostgradulateStudent_Insert]
	...
	@BallPhilosophy				smallint,
	@BallEnglish				smallint,
	@BallSpecial				smallint,
		...
		IF @UniversityName IS NOT NULL AND @Speciality IS NOT NULL AND NOT EXISTS (SELECT 1 
		 ...
		 ELSE 
			...
			BEGIN TRAN
				...
				INSERT INTO [scc].[PostgradulateStudent]
							([PersonID]
							,[BallPhilosophy]
							,[BallEnglish]
							,[BallSpecial]
