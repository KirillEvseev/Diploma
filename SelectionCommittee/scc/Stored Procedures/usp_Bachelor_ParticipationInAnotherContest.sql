...
CREATE PROCEDURE [scc].[usp_Bachelor_ParticipationInAnotherContest]
@PersonID INT
AS
BEGIN
	SET NOCOUNT ON
	...
	IF NOT EXISTS (SELECT 1 FROM [scc].[Decree_Person] WHERE [PersonID] = @PersonID)
		BEGIN
